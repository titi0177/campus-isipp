...
export const Route = createFileRoute('/professor/schedules')({
  component: ProfessorSchedulesPage,
})
...
function ProfessorSchedulesPage() {
  ...
  async function loadSchedules() {
    try {
      ...
      // Obtener horarios asignados al profesor
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600 text-sm mt-1">Horarios de las materias que dicto</p>
      </div>

      {schedules.length === 0 ? (
        <div className="card p-6 text-center">
          <p className="text-slate-500">Aún no tienes horarios asignados.</p>
          <p className="text-slate-400 text-sm mt-1">Los administradores cargarán tus horarios a través del sistema.</p>
        </div>
      ) : (
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-slate-500 mt-1">{s.subject_code} • {s.subject_year}° Año</p>
                        </div>
                ...
                {schedules
                  ...
                  .map(s => (
                    <tr key={s.id} className="border-b hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3">{s.subject_year}°</td>
