...
import {
  ...
  BookMarked, BarChart3, ClipboardCheck, MessageCircle, DollarSign
} from 'lucide-react'
...
const studentNav = [
  ...
  { label: 'Plan', href: '/dashboard/roadmap', icon: <GraduationCap size={20} /> },
]
...
const treasurerNav = [
  ...
  { label: 'Config', href: '/treasurer/configuration', icon: <Settings size={20} /> },
]
...
export function BottomNav({ role }: BottomNavProps) {
  ...
  return (
    <nav
      className="bottom-nav-mobile md:hidden"
      role="navigation"
