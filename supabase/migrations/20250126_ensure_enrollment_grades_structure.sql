-- Verificar estructura de enrollment_grades y asegurar que exista
...
-- Crear trigger para actualizar status del enrollment
...
BEGIN
  ...
  SET status = CASE
    ...
    WHEN NEW.final_status = 'desaprobado' THEN 'desaprobado'
